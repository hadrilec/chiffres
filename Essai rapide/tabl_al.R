tabl_al<-function(dig=1){
  ...
  base_old<<-NULL
row1 <-  ligne_date()
row2 <-f_row("<b>Produit interieur brut</b>","al.pib",VT,VA,base,dig=dig)
...
row8 <-f_row("Demande interieure hors stocks","al.di.contrib",NIV,NIV_AN,base,base_old,"al_an.di.contrib.an",base_an,dig=dig)
row9 <-f_row("Variation de stocks","al.stocks.contrib",NIV,NIV_AN,base,base_old,"al_an.stocks.contrib.an",base_an,dig=dig)
row10 <-f_row("Commerce exterieur","al.comext.contrib",NIV,NIV_AN,base,base_old,"al_an.comext.contrib.an",base_an,dig=dig)
...
row8 <-f_row("Taux de chomage","al_cdm.tx_u_cnt",NIV,NIV_AN,base_cdm,bold=T,dig=dig)
