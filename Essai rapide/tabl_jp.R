tabl_jp<-function(dig=1){
  ...
  base_old<<-NULL
  row1 <-  ligne_date()
  row2 <-f_row("<b>Produit interieur brut</b>","jp.pib",VT,VA,base,dig=dig)
  ...
  row8 <-f_row("Demande interieure hors stocks","jp.di.contrib",NIV,NIV_AN,base,base_old,"jp_an.di.contrib.an",base_an,dig=dig)
  row9 <-f_row("Variation de stocks","jp.stocks.contrib",NIV,NIV_AN,base,base_old,"jp_an.stocks.contrib.an",base_an,dig=dig)
  row10 <-f_row("Commerce exterieur","jp.comext.contrib",NIV,NIV_AN,base,base_old,"jp_an.comext.contrib.an",base_an,dig=dig)
